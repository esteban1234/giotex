      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-7 col-md-6">
            ...
            La innovación en los servicios y el profesionalismo en su equipo de ventas garantizan la más alta rentabilidad a nuestros clientes, además de una excelente atención dentro de un marco de seguridad y confianza tanto para quien compra como para quien vende.<br><br>

            Ofrecemos atención inmobiliaria de manera integral y versátil a todos sus clientes a través de un equipo altamente experimentado y capacitado, empleando los más altos avances tecnológicos, enriquecidos con nuestra red de asociados inmobiliarios y una selecta cartera de proveedores comprometidos con la calidad y el servicio.
            </p>
          </div>
        </div>
      </div>
...
tu casa</h3>
      ...
      <br><br>
        ...
        <div class="boton2">
      <a href="servicios.php"><button type="button" class="btn btn-default btn-lg">¿Cómo invertir?</button></a>
    </div>
           </div>
      </div>
    </div>

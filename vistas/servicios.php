...
<body>
 ...
 <div class="banners">
  <div class="fondon">
    ...
    <div class="pull-right">
      <nav>
        <ul>
          ...
          <a class="selector" id="select" href="servicios.php">¿COMO INVERTIR?</a>
    ...
    <div class="botonn">
      <a href="contacto.php"><button type="button" class="btn btn-danger btn-lg">Conoce Nustros Proyectos</button></a>
    </div>
  </div>
</div>
...
<div class="section" style="padding: 5% 0%;">
  <div class="container">
    <div class="row">
      <p class="textos">GIOTEX INMOBILIARIA le ofrece todos los servicios que necesitan para comprar una vivienda con las mayores facilidades. Ponemos a disposición de nuestros clientes un amplio catálogo de propiedades entre los que encontrarás las mejores viviendas a la venta. <br><br>

      Con el asesoramiento personalizado que ofrecen los agentes inmobiliarios de GIOTEX INMOBILIARIA, nuestros clientes cuentan en todo momento con la información y el consejo necesario para dar con las mejores propiedades en cada caso. <br><br>

      Ofrecemos la ventaja con respecto a otras inmobiliarias de la zona, de trabajar directamente con compradores y vendedores de viviendas, sin intermediarios ni terceras partes cuya participación encarezca la operación. Además ponemos a su disposición las mejores propiedades de nueva construcción. Si quieres comprar una vivienda le ayudaremos a conseguir la mejor opción y con la mayor comodidad.
...
<div class="section" style="padding: 5% 0%; background-color: #BA124F">
    ...
    <div class="section" style="padding: 5% 0%;">
      ...
      <hr> <br><br>
        ...
        <div class="boton2">
      <a href="contacto.php"><button type="button" class="btn btn-default btn-lg">CONTACTANOS</button></a>
    </div>
      </div>
    </div>
